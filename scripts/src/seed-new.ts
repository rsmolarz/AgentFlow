...
async function seedNew() {
  ...
  const integrations = [
    { name: "OpenAI", description: "GPT-4o, GPT-4, DALL-E, Whisper, and embeddings", category: "llm", icon: "🤖", connected: false, popular: true, nodes: 8 },
    { name: "Anthropic", description: "Claude 3.5 Sonnet, Claude 3 Opus, and Haiku models", category: "llm", icon: "🧠", connected: false, popular: true, nodes: 5 },
    { name: "Google AI", description: "Gemini Pro, Gemini Flash, PaLM, and embeddings", category: "llm", icon: "✨", connected: false, popular: false, nodes: 6 },
    ...
    { name: "Slack", description: "Send messages, manage channels, and respond to events", category: "communication", icon: "💬", connected: false, popular: true, nodes: 12 },
    ...
    { name: "Gmail", description: "Read, send, and manage emails with labels and filters", category: "communication", icon: "✉️", connected: false, popular: true, nodes: 10 },
    ...
    { name: "PostgreSQL", description: "Query, insert, update, and manage relational data", category: "database", icon: "🐘", connected: false, popular: true, nodes: 6 },
    ...
    { name: "Google Sheets", description: "Read, write, and manage spreadsheet data", category: "productivity", icon: "📗", connected: false, popular: true, nodes: 8 },
    ...
    { name: "GitHub", description: "Repos, issues, PRs, actions, and webhooks", category: "developer", icon: "🐙", connected: false, popular: true, nodes: 15 },
    ...
    { name: "Pinecone", description: "Vector database for high-performance similarity search", category: "vector", icon: "🌲", connected: false, popular: true, nodes: 4 },
    ...
    { name: "pgvector", description: "PostgreSQL extension for vector similarity search", category: "vector", icon: "🐘", connected: false, popular: false, nodes: 2 },
